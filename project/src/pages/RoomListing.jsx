...
const RoomRow = ({ image, title, description, property, roomType }) => { 
  return (
    <tr className='border-b'>
      ...
      <td className='p-4  text-gray-700'>{property}</td>
...
const RoomsListing = () => {
  ...
  return (
    <div className='bg-gray-100 text-gray-900 min-h-screen p-6 dark:bg-[#0B1739]'>
      <div className="max-w-7xl mx-auto dark:bg-[#0B1739]">
        <div className="flex justify-between items-center mb-6 dark:bg-[#0B1739]">
          <h1 className="text-3xl font-bold dark:text-white">Rooms Listing</h1>
          
        </div>
        <div className='bg-white shadow-md rounded-lg overflow-hidden dark:bg-[#0B1739]'>
          <div className="p-4 flex  items-center dark:bg-[#0B1739]">
            <input
              type="text"
              placeholder=" 🔍 Search by room name"
              className='border rounded-lg px-4 py-2 text-sm w-1/3 bg-white text-gray-900 border-gray-300'
            />
            <div className="flex space-x-4 ">
              <select className='border rounded-lg px-4 py-2 text-sm ml-3bg-white text-gray-900 border-gray-300'>
                <option>Property type</option>
              </select>
              <select className='border rounded-lg px-4 py-2 text-sm bg-white text-gray-900 border-gray-300'>
